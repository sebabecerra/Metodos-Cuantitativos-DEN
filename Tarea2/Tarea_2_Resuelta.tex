...
El coeficiente indica que un punto adicional de presión competitiva se asocia, en promedio, con un aumento de 2.028 puntos porcentuales en el porcentaje de ingresos proveniente de productos o servicios nuevos. Este efecto total no se utiliza como hipótesis formal principal, porque la figura teórica distingue entre el camino directo $c'$, el camino mediado y la moderación de la primera etapa. Sin embargo, se reporta porque permite documentar la asociación global entre presión competitiva y desempeño antes de descomponerla en efecto directo e indirecto. La relación total es positiva y compatible con el modelo propuesto, pero la explicación del mecanismo requiere considerar las regresiones anteriores y el efecto indirecto.
...
Hayes, A. F. (2018). \textit{Introduction to Mediation, Moderation, and Conditional Process Analysis} (2nd ed.). Guilford Press.
