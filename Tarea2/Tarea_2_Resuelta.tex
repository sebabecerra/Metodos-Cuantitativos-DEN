...
El objetivo es analizar cómo las condiciones laborales percibidas por los trabajadores se relacionan con su satisfacción, compromiso organizacional e intención de permanecer en la empresa. En particular, se consideran cinco constructos: actitud hacia compañeros, percepción del ambiente de trabajo, satisfacción laboral, compromiso organizacional e intención de permanencia. Como cada uno fue medido mediante varios ítems, el análisis debe tratar explícitamente el error de medición asociado a los indicadores observados.

Por esta razón, el análisis se desarrolla en dos etapas articuladas. Primero se utiliza análisis factorial confirmatorio (CFA) para evaluar si los indicadores representan adecuadamente sus constructos. Luego se estiman y comparan los modelos de ecuaciones estructurales (SEM) planteados en el enunciado. Esta secuencia es indispensable: si el modelo de medición no es adecuado, las relaciones estructurales entre constructos pierden validez interpretativa.
