...
\noindent\textit{Nota:} $B_H$ y $B_M$ corresponden a coeficientes no estandarizados estimados por separado para hombres y mujeres.
...
Con la evidencia disponible, el compromiso organizacional constituye el mecanismo indirecto potencial más consistente entre PA o AC y la intención de permanecer. Sin embargo, su papel mediador no puede considerarse formalmente confirmado mientras no se estimen los productos indirectos y sus intervalos de confianza bootstrap.
