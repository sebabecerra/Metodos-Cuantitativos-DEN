...
\caption{Síntesis interpretativa de la pregunta 1}
\begin{tabular}{p{3.6cm}p{3.4cm}p{6.2cm}}
\toprule
Resultado & Evidencia & Interpretación\\
\midrule
Efecto total & $c=2.0281$, $p<.001$ & La presión competitiva se asocia positivamente con el desempeño innovador antes de incorporar el mecanismo mediador.\\
Camino hacia el mediador & $a_1=2.0008$, $p<.001$ & Con tolerancia promedio, mayor presión competitiva aumenta la conducta innovadora del empleado.\\
Moderación & $a_3=0.5248$, $p<.001$ & La tolerancia al fracaso fortalece la relación entre presión competitiva y conducta innovadora.\\
Camino hacia el resultado & $b=0.8577$, $p<.001$ & La conducta innovadora se traduce en mayor desempeño innovador de la empresa.\\
Efecto directo residual & $c'=0.0265$, $p=.590$ & Al controlar la conducta innovadora, la presión competitiva ya no presenta un efecto directo significativo.\\
Mediación moderada & Índice $=0.4502$, IC95\% $[0.3758,0.5184]$ & El mecanismo indirecto es significativamente más fuerte cuando la tolerancia al fracaso es mayor.\\
\bottomrule
\end{tabular}
\end{table}

En términos prácticos, la presión competitiva por sí sola no garantiza innovación. Su efecto aparece principalmente cuando los empleados responden con conductas innovadoras, y esta respuesta es más intensa en culturas organizacionales que permiten experimentar sin castigar excesivamente los errores. Por ello, una empresa sometida a alta presión competitiva debería acompañar esa presión con una cultura de aprendizaje y tolerancia al fracaso para convertirla en resultados innovadores.
