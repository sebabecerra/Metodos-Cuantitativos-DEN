...
\toprule
Modelo & $\chi^2$ & gl & CFI & TLI & RMSEA & $\Delta\chi^2$ & $\Delta gl$ & $\Delta CFI$ \\
\midrule
Configural & 403.4729 & 320 & .9762 & .9717 & .0256 & -- & -- & -- \\
Métrica completa & 461.4383 & 335 & .9639 & .9591 & .0308 & 57.9654 & 15 & -.0123 \\
Métrica parcial (libera CO3) & 439.3743 & 334 & .9699 & .9658 & .0281 & 35.9015 & 14 & -.0062 \\
Escalar completa & 492.5408 & 349 & .9591 & .9554 & .0321 & 53.1665 & 15 & -.0109 \\
Estructural completa & 468.3867 & 343 & .9642 & .9604 & .0303 & 29.0124 & 9 & -.0057 \\
Estructural parcial (libera $AC\rightarrow ST$ y $PA\rightarrow IP$) & 448.9107 & 341 & .9692 & .9657 & .0282 & 9.5364 & 7 & -.0007 \\
\bottomrule
\end{tabular}}
\end{table}
...
Los resultados muestran que el modelo configural presenta buen ajuste, por lo que la estructura general es plausible tanto en hombres como en mujeres. La invariancia métrica completa queda levemente fuera del criterio práctico ($\Delta CFI=-.0123$). Al liberar la carga de CO3, se obtiene invariancia métrica parcial ($\Delta CFI=-.0062$), suficiente para comparar caminos estructurales con cautela.

La invariancia escalar completa no se sostiene plenamente ($\Delta CFI=-.0109$). Esto no impide comparar relaciones estructurales, pero sí indica que sería necesario mayor cuidado si el objetivo fuera comparar medias latentes entre hombres y mujeres.

Al imponer igualdad de todos los caminos estructurales, la prueba de diferencia de $\chi^2$ sugiere cierto deterioro del ajuste. Sin embargo, al liberar únicamente dos relaciones, $AC\rightarrow ST$ y $PA\rightarrow IP$, se obtiene un modelo de invariancia estructural parcial aceptable: $\Delta\chi^2(7)=9.5364$, $p=.2164$, $\Delta CFI=-.0007$.

Como apoyo descriptivo, la comparación directa de coeficientes no estandarizados mostró que $AC\rightarrow ST$ cambia de signo entre grupos: en hombres fue negativo ($B=-.2145$), mientras que en mujeres fue positivo ($B=.3509$). Además, $PA\rightarrow IP$ fue más fuerte en mujeres ($B=.2385$) que en hombres ($B=.0984$).

Por tanto, la respuesta al inciso es que la mayoría de las relaciones estructurales se comportan de manera equivalente entre hombres y mujeres. Las diferencias principales se concentran en dos caminos: la asociación entre actitud hacia compañeros y satisfacción laboral, y la asociación directa entre percepción del ambiente e intención de permanecer.
...
El análisis por género muestra que la estructura general del modelo es comparable entre hombres y mujeres bajo invariancia métrica parcial. La mayoría de las relaciones estructurales son equivalentes, pero dos caminos requieren liberarse: $AC\rightarrow ST$ y $PA\rightarrow IP$. En términos sustantivos, esto sugiere que algunas condiciones laborales pueden relacionarse con satisfacción e intención de permanencia de manera distinta según género, aunque el patrón general del modelo se mantiene.

En conjunto, la evidencia respalda el modelo parcialmente mediado como la mejor representación de los datos, con equivalencia estructural mayoritaria entre hombres y mujeres y diferencias específicas en dos relaciones.
...
En conjunto, los resultados muestran que las relaciones analizadas no son puramente directas. La presión competitiva se relaciona con el desempeño a través de la conducta innovadora y bajo una cultura favorable; la teoría de Blend emerge en cuatro dimensiones aunque requiere depuración de ítems; la intención de permanecer se asocia principalmente con el ambiente, las relaciones con compañeros y el compromiso, con equivalencia estructural mayoritaria por género y diferencias específicas en dos caminos; y la lealtad se asocia conjuntamente con canal y tamaño. Esta lectura sustantiva, además del reporte estadístico, es la principal conclusión metodológica de la tarea.
