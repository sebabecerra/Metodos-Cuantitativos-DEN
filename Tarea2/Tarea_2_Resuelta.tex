...
\title{\textbf{TAREA \#2--3--4 RESUELTA}\\[6pt]\large Métodos Cuantitativos de Investigación en Negocios\\[4pt]\normalsize Ponderación: 65\%}
...
Este documento presenta la resolución completa de la Tarea \#2-3-4. Para cada pregunta se reproduce el enunciado, se describen los pasos seguidos, se reportan los resultados necesarios y se interpreta la evidencia estadística con un nivel de significancia de $\alpha=0.05$.

Los cálculos fueron realizados en Python y se encuentran respaldados por notebooks individuales reproducibles, uno por pregunta, incluidos en la carpeta de entrega.
