...
El resultado central es la interacción positiva y significativa. El coeficiente $a_3=0.5248$ indica que, por cada unidad adicional de tolerancia al fracaso, la pendiente de presión competitiva sobre conducta innovadora aumenta en aproximadamente 0.525 unidades. En términos sustantivos, la presión competitiva se asocia con una respuesta innovadora más intensa cuando la organización acepta los errores propios de la experimentación. Se apoyan H2 y H5.
...
La estructura general es interpretable, pero no perfecta. q1, q9 y q27 muestran complejidad o cargas cruzadas; q10 y q21 no coinciden limpiamente con una sola dimensión teórica; q14 y q18 presentan cargas secundarias relevantes; q12 no alcanza 0.40 en ningún factor; y q15 también es débil. Una carga cruzada reduce la pureza conceptual de la escala, porque el ítem parece recoger contenido de más de una dimensión. En q12, el problema es aún más claro: no se vincula de manera sustantiva con ninguno de los factores y sería el candidato más evidente a revisión o eliminación.
...
No obstante, el apoyo no es perfecto a nivel de ítems. q1, q9 y q27 son complejos; q10 y q21 no coinciden limpiamente con una única dimensión; q12 y q15 son débiles; y la dimensión interpersonal presenta menor consistencia. Por tanto, el EECS-R reproduce las cuatro dimensiones principales, pero sería recomendable revisar los ítems problemáticos y validar una versión depurada mediante CFA en una muestra independiente.
...
La percepción del ambiente tiene un efecto positivo y significativo sobre la satisfacción ($B=.1848$, $\beta=.237$, $p<.001$). Una percepción más favorable del ambiente físico y funcional se asocia con mayor satisfacción laboral.
...
Escalar completa & 492.5408 & 349 & .9591 & .9554 & .0321 & 53.1665 & 15 & $<.001$ & -.0109 \\
Estructural completa & 468.3867 & 343 & .9642 & .9604 & .0303 & 29.0124 & 9 & $<.001$ & -.0057 \\
Estructural parcial (libera $AC\rightarrow ST$ y $PA\rightarrow IP$) & 448.9107 & 341 & .9692 & .9657 & .0282 & 9.5364 & 7 & .2164 & -.0007 \\
\bottomrule
\end{tabular}}
\end{table}

\noindent\textit{Nota:} la métrica completa se compara contra el modelo configural; la métrica parcial también se compara contra el configural. La escalar completa y los modelos estructurales se comparan contra la métrica parcial. Para la estructura parcial, $\Delta\chi^2(7)=9.5364$, $p=.2164$.

Los resultados muestran que el modelo configural presenta buen ajuste, por lo que la estructura general es plausible tanto en hombres como en mujeres. La invariancia métrica completa queda levemente fuera del criterio práctico ($\Delta CFI=-.0123$). Mediante inspección secuencial de liberaciones de cargas factoriales, se identificó que permitir que la carga factorial de CO3 difiriera entre hombres y mujeres producía la mayor mejora de ajuste. Con esa liberación se obtiene invariancia métrica parcial ($\Delta CFI=-.0062$), suficiente para comparar caminos estructurales con cautela.

Desde la métrica parcial se siguen dos ramas analíticas. La primera es la evaluación de invariancia escalar, relevante principalmente para comparar medias latentes. La segunda es la evaluación de invariancia estructural, que compara los caminos entre constructos. La invariancia escalar completa no se sostiene plenamente ($\Delta CFI=-.0109$), pero esto no impide comparar relaciones estructurales, porque para ello la condición central es contar al menos con invariancia métrica parcial.

Al imponer igualdad de todos los caminos estructurales, la prueba de diferencia de $\chi^2$ sugiere cierto deterioro del ajuste. Sin embargo, al liberar el conjunto de restricciones asociado a $AC\rightarrow ST$ y $PA\rightarrow IP$, se obtiene un modelo de invariancia estructural parcial aceptable: $\Delta\chi^2(7)=9.5364$, $p=.2164$, $\Delta CFI=-.0007$. La decisión de aceptación se basa principalmente en $\Delta CFI$, porque la prueba de $\chi^2$ es sensible al tamaño muestral y puede rechazar restricciones pequeñas.

Como apoyo descriptivo, la comparación directa de coeficientes no estandarizados mostró que $AC\rightarrow ST$ cambia de signo entre grupos: en hombres fue negativo ($B=-.2145$), mientras que en mujeres fue positivo ($B=.3509$). Además, $PA\rightarrow IP$ fue más fuerte en mujeres ($B=.2385$) que en hombres ($B=.0984$). Estos contrastes ayudan a interpretar la dirección de la falta de invariancia, pero demostrar que cada camino difiere individualmente requeriría pruebas específicas de liberación o restricción camino por camino.

Por tanto, la respuesta al inciso es que la mayoría de las relaciones estructurales se comportan de manera equivalente entre hombres y mujeres. La falta de invariancia se concentra en el conjunto de restricciones asociado a $AC\rightarrow ST$ y $PA\rightarrow IP$, más que en una demostración definitiva de diferencia individual para cada camino por separado.
...
El análisis por género muestra que la estructura general del modelo es comparable entre hombres y mujeres bajo invariancia métrica parcial. La mayoría de las relaciones estructurales son equivalentes; sin embargo, el modelo mejora cuando se libera el conjunto de restricciones asociado a $AC\rightarrow ST$ y $PA\rightarrow IP$. En términos sustantivos, esto sugiere que algunas condiciones laborales podrían relacionarse con satisfacción e intención de permanencia de manera distinta según género, aunque el patrón general del modelo se mantiene.

En conjunto, la evidencia respalda el modelo parcialmente mediado como la mejor representación de los datos, con equivalencia estructural mayoritaria entre hombres y mujeres y una falta de invariancia localizada en el conjunto de restricciones asociado a dos relaciones.
...
No. La interacción multivariada fue significativa. La ventaja del canal directo varía según el tamaño y es especialmente intensa entre empresas grandes, sobre todo en satisfacción y recompra.

\subsection{Conclusión de la pregunta 4}

El tipo de distribución y el tamaño se asocian con el perfil conjunto de lealtad. Los clientes atendidos directamente presentan mejores resultados y las empresas grandes muestran mayor lealtad promedio. Sin embargo, ambos factores no operan independientemente: la eficacia del canal directo es mayor entre empresas grandes.
...
En conjunto, los resultados muestran que las relaciones analizadas no son puramente directas. La presión competitiva se relaciona con el desempeño a través de la conducta innovadora y bajo una cultura favorable; la teoría de Blend emerge en cuatro dimensiones aunque requiere depuración de ítems; la intención de permanecer se asocia principalmente con el ambiente, las relaciones con compañeros y el compromiso, con equivalencia estructural mayoritaria por género y falta de invariancia localizada en dos restricciones estructurales; y la lealtad se asocia conjuntamente con canal y tamaño. Esta lectura sustantiva, además del reporte estadístico, es la principal conclusión metodológica de la tarea.
