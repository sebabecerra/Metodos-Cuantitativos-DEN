...
\begin{figure}[H]
\centering
\includegraphics[width=0.72\textwidth]{p4_interaccion_satisfaccion.png}
\caption{Interacción entre tipo de distribución y tamaño de empresa sobre satisfacción, generada desde el notebook de la Pregunta 4.}
\label{fig:p4-interaccion-satisfaccion}
\end{figure}
