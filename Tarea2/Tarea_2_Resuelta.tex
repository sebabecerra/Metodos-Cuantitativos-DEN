...
El resultado central es la interacción positiva y significativa. El coeficiente $a_3=0.5248$ indica que la pendiente de presión competitiva sobre conducta innovadora aumenta en aproximadamente 0.525 ideas por cada punto adicional de tolerancia al fracaso. En términos sustantivos, la presión competitiva se asocia con una respuesta innovadora más intensa cuando la organización acepta los errores propios de la experimentación. Se apoyan H2 y H5.
...
\noindent\textit{Nota:} la métrica completa se compara contra el modelo configural; la métrica parcial también se compara contra el configural. La escalar completa y la estructural completa se comparan contra la métrica parcial.
...
Desde la métrica parcial se siguen dos ramas analíticas. La primera es la evaluación de invariancia escalar, relevante principalmente para comparar medias latentes. La segunda es la evaluación de invariancia estructural, que compara los caminos entre constructos. La invariancia escalar completa no se sostiene plenamente ($\Delta CFI=-.0109$). Por tanto, no se realizaron comparaciones de medias latentes entre hombres y mujeres.

La invariancia estructural completa sí se considera aceptable porque su caída en CFI es pequeña ($\Delta CFI=-.0057$), inferior al umbral de .010. En consecuencia, no se rechaza la equivalencia de los caminos estructurales entre hombres y mujeres bajo el criterio principal adoptado.
...
El análisis por género muestra que la estructura general del modelo es comparable entre hombres y mujeres bajo invariancia métrica parcial. Además, se acepta invariancia estructural completa bajo el criterio principal de $\Delta CFI\leq .010$. Por ello, los caminos estructurales del modelo pueden considerarse equivalentes entre hombres y mujeres. Dado que no se alcanzó invariancia escalar completa, no se realizaron comparaciones de medias latentes.
...
Desde una perspectiva gerencial, los resultados sugieren que HBAT podría priorizar la fuerza de ventas directa para clientes grandes, donde su asociación con satisfacción y recompra es especialmente fuerte, y evaluar estrategias diferenciadas para empresas pequeñas. Estas conclusiones describen asociaciones y no prueban causalidad definitiva, pues el canal podría estar relacionado con otras características no incluidas en el modelo.
...
En conjunto, los resultados muestran que las relaciones analizadas no son puramente directas. En la primera pregunta, la evidencia es consistente con una relación indirecta entre presión competitiva y desempeño a través de la conducta innovadora, bajo una cultura favorable; la teoría de Blend emerge en cuatro dimensiones aunque requiere depuración de ítems; la intención de permanecer se asocia principalmente con el ambiente, las relaciones con compañeros y el compromiso, con invariancia estructural entre hombres y mujeres; y la lealtad se asocia conjuntamente con canal y tamaño. Esta lectura sustantiva, además del reporte estadístico, es la principal conclusión metodológica de la tarea.
