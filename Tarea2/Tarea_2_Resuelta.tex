...
\paragraph{Supuestos y alcance causal.} No se detectaron problemas relevantes de colinealidad ni heterocedasticidad: todos los VIF fueron inferiores a 1.05 y la prueba de Breusch--Pagan no fue significativa ($LM=1.14$, $p=0.767$). Además, se utilizaron errores estándar robustos HC3. Aunque los resultados son compatibles con el mecanismo propuesto, la interpretación causal definitiva depende del diseño de recolección de datos y de la ausencia de confusores omitidos importantes.
