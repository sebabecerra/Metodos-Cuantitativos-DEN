...
Como contraste, se estimó también una solución con rotación Varimax. Varimax es una rotación ortogonal y, por tanto, fuerza correlaciones iguales a cero entre los factores. Esta solución acumuló 45.9\% de varianza, pero redistribuyó varias cargas y produjo una estructura menos alineada con el supuesto teórico de dimensiones relacionadas. Por ejemplo, algunos ítems quedaron con patrones más mezclados entre factores. Por ello, Varimax se interpreta solo como análisis de robustez y no como solución final. La decisión principal se basa en Oblimin porque respeta la posibilidad teórica y empírica de correlación entre las dimensiones.
