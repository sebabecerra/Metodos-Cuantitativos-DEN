...
\caption{Respuesta directa a las hipótesis de la pregunta 1}
\begin{tabular}{p{1.8cm}p{6.5cm}p{5.0cm}}
\toprule
Hipótesis & Resultado estadístico & Respuesta directa\\
\midrule
H1 & $c=2.0281$, $p<.001$ & Se apoya: la presión competitiva tiene efecto total positivo sobre desempeño innovador.\\
H2 & $a_1=2.0008$, $p<.001$ & Se apoya: la presión competitiva aumenta la conducta innovadora.\\
H3 & $b=0.8577$, $p<.001$ & Se apoya: la conducta innovadora aumenta el desempeño innovador.\\
H4 & Efectos indirectos condicionales con IC95\% sin cero & Se apoya: existe mediación por conducta innovadora.\\
H5 & $a_3=0.5248$, $p<.001$ & Se apoya: la tolerancia al fracaso fortalece el camino presión--conducta innovadora.\\
H6 & Índice = 0.4502; IC95\% [0.3758, 0.5184] & Se apoya: la mediación es más fuerte cuando la tolerancia al fracaso es alta.\\
\bottomrule
\end{tabular}
\end{table}

En términos sustantivos, la presión competitiva no mejora el desempeño innovador simplemente por existir. Su efecto aparece cuando los empleados responden proponiendo e implementando ideas nuevas. Esa respuesta es más fuerte en empresas donde la gerencia tolera el fracaso asociado a experimentar. Por lo tanto, una organización sometida a presión competitiva debería fomentar una cultura que permita aprender de los errores, porque esa cultura facilita transformar presión de mercado en innovación real.
