...
\title{\textbf{TAREA 2 RESUELTA}\\[6pt]\large Métodos Cuantitativos de Investigación en Negocios}
...
Este documento presenta la resolución completa de la Tarea 2. Para cada pregunta se reproduce el enunciado, se describen los pasos seguidos, se reportan los resultados necesarios y se interpreta la evidencia estadística con un nivel de significancia de $\alpha=0.05$.
