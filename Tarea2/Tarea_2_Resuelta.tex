...
\bigskip
\noindent\textbf{a) ¿Por qué corresponde realizar un análisis factorial exploratorio y cómo se prepararon los datos?}
...
\bigskip
\noindent\textbf{b) ¿La matriz de datos es adecuada para realizar el análisis factorial?}
...
\bigskip
\noindent\textbf{c) ¿Cuántos factores deben retenerse?}
...
\bigskip
\noindent\textbf{d) ¿Cómo se interpretan los factores y se cumple la teoría de Blend?}
...
\bigskip
\noindent\textbf{Conclusión sobre la teoría de Blend.}
...
\bigskip
\noindent\textbf{Resultados de confiabilidad y validez del modelo de medición.}
...
\bigskip
\noindent\textbf{a), b) y c) Planteamiento común para responder los incisos.}
