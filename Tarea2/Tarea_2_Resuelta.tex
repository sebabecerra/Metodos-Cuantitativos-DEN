...
\caption{Figura 1 del enunciado: modelo conceptual de mediación moderada. La cultura de tolerancia al fracaso modera el camino entre presión competitiva y conducta innovadora, y el modelo conserva el camino directo entre presión competitiva y desempeño innovador.}
...
\item H3: la presión competitiva mantiene una asociación directa positiva con el desempeño innovador una vez incorporada la conducta innovadora ($c'>0$).
...
\begin{figure}[H]
\centering
\includegraphics[width=0.82\textwidth]{p3_modelo_completamente_mediado.png}\\[6pt]
\includegraphics[width=0.82\textwidth]{p3_modelo_parcialmente_mediado.png}
\caption{Modelos estructurales del enunciado: modelo completamente mediado (arriba) y modelo parcialmente mediado (abajo). El modelo parcial agrega caminos directos desde percepción del ambiente y actitud hacia compañeros hacia intención de permanecer.}
\label{fig:p3-modelos}
\end{figure}
