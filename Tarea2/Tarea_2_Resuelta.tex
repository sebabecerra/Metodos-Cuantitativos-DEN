...
El modelo explica el 98.05\% de la variación en conducta innovadora ($R^2=0.9805$). Con tolerancia al fracaso en su media, un punto adicional de presión competitiva se asocia con aproximadamente dos ideas adicionales propuestas por el empleado durante el período considerado. A su vez, con presión competitiva en su media, un punto adicional de tolerancia al fracaso se asocia con aproximadamente 2.87 ideas adicionales.
...
El coeficiente indica que un punto adicional de presión competitiva se asocia, en promedio, con un aumento de 2.028 puntos porcentuales en el porcentaje de ingresos proveniente de productos o servicios nuevos. Este efecto total no se utiliza como hipótesis formal principal, porque la figura teórica distingue entre el camino directo $c'$, el camino mediado y la moderación de la primera etapa. Sin embargo, se reporta porque permite documentar la asociación global entre presión competitiva y desempeño antes de descomponerla en efecto directo e indirecto. En este modelo, el efecto total de la regresión simple no tiene por qué coincidir exactamente con $c'$ más el efecto indirecto evaluado en la media del moderador, porque la ecuación de resultado no incluye $W$ ni $XW$ y la regresión total absorbe asociación compartida entre $X$ y $W$. La relación total es positiva y compatible con el modelo propuesto, pero la explicación del mecanismo requiere considerar las regresiones anteriores y el efecto indirecto.
...
Carga secundaria cercana o superior a .30 & q1, q2, q9, q14, q18, q27 \\
...
El excelente ajuste del modelo parcial debe interpretarse con prudencia. La parte estructural entre las cinco variables latentes queda exactamente saturada al incluir los nueve caminos propuestos; por eso su ajuste global coincide con el del CFA de medición. Por ello, la comparación no demuestra causalidad; solo indica que las restricciones adicionales del modelo completamente mediado no son compatibles con los datos.
